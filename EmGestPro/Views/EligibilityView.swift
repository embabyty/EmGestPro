...
struct EligibilityView: View {
    ...
    private var explanation: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            Text("EmGestPro merges these answers into the existing eligibility plist. It keeps unrelated state intact and saves the original file before the first change.")
                .font(.footnote)
                .foregroundStyle(.secondary)
        }
    }

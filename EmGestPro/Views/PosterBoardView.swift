...
extension UIDocumentPickerViewController {
    @objc func EmGestPro_init(forOpeningContentTypes contentTypes: [UTType], asCopy: Bool) -> UIDocumentPickerViewController {
        EmGestPro_init(forOpeningContentTypes: contentTypes, asCopy: true)
    }
}
...
struct PosterBoardView: View {
    ...
    private static let swizzleOnce: Void = {
        let replacement = class_getInstanceMethod(
            ...
            #selector(UIDocumentPickerViewController.EmGestPro_init(forOpeningContentTypes:asCopy:))
        )!
